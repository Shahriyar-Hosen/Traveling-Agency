  ...
  return (
    ...
    >
      <Content>
        ...
        {/* cards */}
        <div className="w-full pt-10 px-5 flex justify-center items-center justify-items-center flex-col md:grid md:grid-cols-2 lg:grid-cols-4 gap-5 place-content-center">
